                        ...
                        <tbody>
                          {Object.keys(formatedData[prod]).map((reg, key1) => {
                            ...
                            Object.keys(formatedData[prod][reg]).forEach(
                              (ctry) => {
                                q1reg =
                                  q1reg + formatedData[prod][reg][ctry]["0"];
                                q2reg =
                                  q2reg + formatedData[prod][reg][ctry]["1"];
                                q3reg =
                                  q3reg + formatedData[prod][reg][ctry]["2"];
                                q4reg =
                                  q4reg + formatedData[prod][reg][ctry]["3"];
                              }
                            );
                            ...
                            return [
                              ...
                              Object.keys(formatedData[prod][reg]).map(
                                (cty) => {
                                  ...
                                  return [
                                    <tr>
                                      <td className="countrycol">{cty}</td>
                                      {Object.keys(
                                        formatedData[prod][reg][cty]
                                      ).map((q) => {
                                        let index = ind;
