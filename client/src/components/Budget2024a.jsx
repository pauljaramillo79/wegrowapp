    ...
    if (prodList) {
      if (searchterm && searchterm !== "") {
        const results = prodList.filter((item) => {
          if (searchterm && searchterm !== "") {
            return item.abbreviation.toLowerCase().includes(searchterm.toLowerCase());
          }
        });
  ...
  return (
    <div>
      <div className='bdgttitles'>
        ...
        {lock === false ? <ExportToCSV csvData={bdgtregiondta} fileName={"budget2024"} /> : ""}
      </div>
        ...
        <ul className='bdgttotalsul'>
            ...
            <div className='bdgtlyearfigs'>
              ...
              <p>
                {lysalestotals && lysalestotals["quantity"]
                  ? lysalestotals["quantity"].toFixed().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
                  : ""}{" "}
                mt
              </p>
            </div>
            ...
            <div className='bdgtlyearfigs'>
              ...
              <p>
                {lysalestotals && lysalestotals["revenue"]
                  ? "$" + lysalestotals["revenue"].toFixed().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
                  : ""}
              </p>
            </div>
            <div className='bdgtlyearfigs'>
            ...
            <div className='bdgtlyearfigs'>
              ...
              <p>
                {lysalestotals && lysalestotals["profit"]
                  ? "$" + lysalestotals["profit"].toFixed().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
                  : ""}
              </p>
            </div>
            <div className='bdgtlyearfigs'>
          ...
          <li>
            ...
            <div className='bdgtlyearfigs'>
              <p>{bdgtyear - 1} YTD:</p>
              <p>
                {lysalestotals && lysalestotals["quantity"] && lysalestotals["profit"]
                  ? "$" +
          ...
          <li>
            ...
            <div className='bdgtlyearfigs'>
              <p>{bdgtyear - 1} YTD:</p>
              <p>
                {lysalestotals && lysalestotals["profit"] && lysalestotals["revenue"]
                  ? ((lysalestotals["profit"] / lysalestotals["revenue"]) * 100).toFixed(1)
                  : ""}
                %
              </p>
            </div>
                                    ...
                                    return (
                                      <div className='addctyrow'>
                                        <input
                                          ...
                                          onClick={(e) => {
                                            if (e.target.checked && prodcountriestoadd) {
                                              setProdcountriestoadd({
                                                ...prodcountriestoadd,
                                                [prod]: {
                                                  ...prodcountriestoadd[prod],
                                                  [ctyel.countryID]: ctyel.country,
                                                },
                                              });
                                            } else {
                                              setProdcountriestoadd((current) => {
                                                ...
                                                delete copy[prod][ctyel.countryID];
                                                return copy;
                                              });
                                            }
                                          }}
                                        />
                                        <label for={ctyel.countyID}>{ctyel.country}</label>
                                      </div>
                                    );
                                  })
                                : ""}
                          ...
                          <table>
                            ...
                            <tbody>
                              {Object.keys(formatedData[prod]).map((reg, key1) => {
                                ...
                                bdgtpriceprodtotal = bdgtpriceprodtotal + priceqty;
                                bdgtprofitprodtotal = bdgtprofitprodtotal + profitqty;
                                                    ...
                                                    onClick={(e) => {
                                                      if (e.target.checked && prodcountriestoadd) {
                                                        ...
                                                        setProdcountriestoadd((current) => {
                                                          ...
                                                          delete copy[prod][el.countryID];
                                                          return copy;
                                                        });
                                                      }
                                                    }}
                                                  />
                                                  <label for={el.countryID}>{el.country}</label>
                                                </div>
                                              ))
                                            : ""}
                                        </div>
                                              ...
                                              setShowdelctybtns({
                                                ...
                                                [prod]: {
                                                  ...
                                                  [reg]: {
                                                    ...
                                                    [cty]: !showdelctybtns[prod][reg][cty],
                                                  },
                                                },
                                              });
                                            }}
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className='bdgtprodtotals bdgtcountrytotals'>
                            {bdgtq1qtytotal + bdgtq2qtytotal + bdgtq3qtytotal + bdgtq4qtytotal}
                          </td>
                          <td className='bdgtcolseparation'></td>
                          ...
                          <td className='bdgtctyeconomics bdgtprodtotals' style={{ width: "auto" }}>
                            {"$ " + bdgtprofitprodtotal}
                          </td>
                          <td className='bdgtctyeconomics bdgtprodtotals' style={{ width: "auto" }}>
                            {((bdgtprofitprodtotal / bdgtpriceprodtotal) * 100).toFixed(0) + "%"}
                          </td>
                        </tr>
                      </tbody>
                    </table>
